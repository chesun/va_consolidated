...
OUTPUTS (CANONICAL per ADR-0021 sandbox; verified via grep on file body)
    $logdir/va_spec_fb_tab_all.smcl (via log using)
    $logdir/va_spec_fb_tab_all.smcl + $logdir/va_spec_fb_tab_all.log (translate)
...
log using "$logdir/va_spec_fb_tab_all.smcl", replace text
...
log close
translate $logdir/va_spec_fb_tab_all.smcl $logdir/va_spec_fb_tab_all.log, replace
