...
OUTPUTS (CANONICAL per ADR-0021 sandbox; verified via grep on file body)
    $logdir/reg_out_va_tab.smcl (via log using)
    $logdir/reg_out_va_tab.smcl + $logdir/reg_out_va_tab.log (translate)
...
log using "$logdir/reg_out_va_tab.smcl", replace text
...
log close
translate $logdir/reg_out_va_tab.smcl $logdir/reg_out_va_tab.log, replace
