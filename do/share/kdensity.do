...
OUTPUTS (CANONICAL per ADR-0021 sandbox; verified via grep on file body)
    ...
    $logdir/kdensity.smcl (via log using)
    $logdir/kdensity.smcl + $logdir/kdensity.log (translate)
...
log using "$logdir/kdensity.smcl", replace text
...
log close
translate $logdir/kdensity.smcl $logdir/kdensity.log, replace
