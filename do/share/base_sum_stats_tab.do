...
OUTPUTS (CANONICAL per ADR-0021 sandbox; verified via grep on file body)
    $logdir/base_sum_stats_tab.smcl (via log using)
    $logdir/base_sum_stats_tab.smcl + $logdir/base_sum_stats_tab.log (translate)
...
log using "$logdir/base_sum_stats_tab.smcl", replace text
...
log close
translate $logdir/base_sum_stats_tab.smcl $logdir/base_sum_stats_tab.log, replace
