...
OUTPUTS (CANONICAL per ADR-0021 sandbox; verified via grep on file body)
    $logdir/sample_counts_tab.smcl (via log using)
    $logdir/sample_counts_tab.smcl + $logdir/sample_counts_tab.log (translate)
...
log using "$logdir/sample_counts_tab.smcl", replace text
...
log close
translate $logdir/sample_counts_tab.smcl $logdir/sample_counts_tab.log, replace
