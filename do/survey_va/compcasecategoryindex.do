...
OUTPUTS (CANONICAL per ADR-0021 sandbox; verified via grep on file body)
    ...
    $logdir/compcasecategoryindex.smcl + .log
...
log using "$logdir/compcasecategoryindex.smcl", replace text
...
cap log close
translate $logdir/compcasecategoryindex.smcl $logdir/compcasecategoryindex.log, replace
