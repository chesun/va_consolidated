...
OUTPUTS (CANONICAL per ADR-0021 sandbox; verified via grep on file body)
    ...
    $logdir/imputedcategoryindex.smcl + .log
...
log using "$logdir/imputedcategoryindex.smcl", replace text
...
cap log close
translate $logdir/imputedcategoryindex.smcl $logdir/imputedcategoryindex.log, replace
