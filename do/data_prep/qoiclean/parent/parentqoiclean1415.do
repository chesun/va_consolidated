...
OUTPUTS (CANONICAL per ADR-0021 sandbox; verified via grep on file body)
    ...
    $logdir/parentqoiclean1415.smcl (via log using)
    $logdir/parentqoiclean1415.smcl + $logdir/parentqoiclean1415.log (translate)
...
log using "$logdir/parentqoiclean1415.smcl", replace text
...
log close
translate $logdir/parentqoiclean1415.smcl $logdir/parentqoiclean1415.log, replace 
