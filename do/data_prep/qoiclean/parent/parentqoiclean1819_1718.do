...
OUTPUTS (CANONICAL per ADR-0021 sandbox; verified via grep on file body)
    ...
    $logdir/data_prep/qoiclean/parent/parentqoiclean1819_1718.smcl (via log using)
    $logdir/data_prep/qoiclean/parent/parentqoiclean1819_1718.smcl + $logdir/data_prep/qoiclean/parent/parentqoiclean1819_1718.log (translate)
