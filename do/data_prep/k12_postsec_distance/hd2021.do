/*------------------------------------------------------------------------------
do/data_prep/k12_postsec_distance/hd2021.do — Phase 1a §3.3 step 9 batch 9c relocation
================================================================================

PURPOSE
    load IPEDS HD 2021 directory; runs (not do) — caller continues with hd2021 in memory; reads $distance_dtadir/raw/hd2021_data_stata.csv (LEGACY raw).
...
INPUTS (verified via grep on file body)
    $distance_dtadir/raw/hd2021_data_stata.csv  (LEGACY read)
...
RELOCATION (per plan v3 §3.3 step 9 batch 9c, applied 2026-05-08)
    Source: cde_va_project_fork/do_files/k12_postsec_distance/hd2021.do
...
REFERENCES
    ...
    Sister files (this batch): check_merge.do, merge_k12_postsec_dist.doh, k12_postsec_distances.do, reconcile_cdscodes.do
...
/* this program is called in k12_postsec_distances.do
 */
*
insheet using "$distance_dtadir/raw/hd2021_data_stata.csv", comma clear
