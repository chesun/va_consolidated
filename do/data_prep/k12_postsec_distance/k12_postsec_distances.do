...
OUTPUTS (CANONICAL per ADR-0021 sandbox; verified via grep on file body)
    ...
    $logdir/k12_postsec_distances.smcl (via log using)
    $logdir/k12_postsec_distances.smcl + $logdir/k12_postsec_distances.log (translate)
...
log using "$logdir/k12_postsec_distances.smcl", replace text
...
log close
translate $logdir/k12_postsec_distances.smcl $logdir/k12_postsec_distances.log, replace
