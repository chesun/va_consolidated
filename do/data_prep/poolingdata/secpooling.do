...
OUTPUTS (CANONICAL per ADR-0021 sandbox; verified via grep on file body)
    ...
    $logdir/secpooling.smcl (via log using)
    $logdir/secpooling.smcl + $logdir/secpooling.log (translate)
...
log using "$logdir/secpooling.smcl", replace text
...
log close
translate $logdir/secpooling.smcl $logdir/secpooling.log, replace 
