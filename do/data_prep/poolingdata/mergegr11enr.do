...
OUTPUTS (CANONICAL per ADR-0021 sandbox; verified via grep on file body)
    ...
    $logdir/mergegr11enr.smcl (via log using)
    $logdir/mergegr11enr.smcl + $logdir/mergegr11enr.log (translate)
...
log using "$logdir/mergegr11enr.smcl", replace text
...
log close
translate $logdir/mergegr11enr.smcl $logdir/mergegr11enr.log, replace 
