...
cap mkdir "$figures_dir/va_cfr_all_v1/het_reg_prior_score"
cap mkdir "$figures_dir/va_cfr_all_v1/het_reg_chars"
cap mkdir "$figures_dir/va_cfr_all_v1/het_reg_combined_panels"
cap mkdir "$figures_dir/va_cfr_all_v1/het_reg_combined_panels/score_va"
cap mkdir "$figures_dir/va_cfr_all_v2"
cap mkdir "$figures_dir/va_cfr_all_v2/het_reg_prior_score"
cap mkdir "$figures_dir/va_cfr_all_v2/het_reg_chars"
cap mkdir "$figures_dir/va_cfr_all_v2/het_reg_combined_panels"
cap mkdir "$figures_dir/va_cfr_all_v2/het_reg_combined_panels/score_va"
cap mkdir "$output_dir"
cap mkdir "$output_dir/gph_files"
cap mkdir "$output_dir/gph_files/va_cfr_all_v1"
cap mkdir "$output_dir/gph_files/va_cfr_all_v1/het_reg_prior_score"
cap mkdir "$output_dir/gph_files/va_cfr_all_v1/het_reg_chars"
cap mkdir "$output_dir/gph_files/va_cfr_all_v2"
cap mkdir "$output_dir/gph_files/va_cfr_all_v2/het_reg_prior_score"
cap mkdir "$output_dir/gph_files/va_cfr_all_v2/het_reg_chars"
cap mkdir "$logdir"
...
cap log close reg_out_va_all_fig

log using "$logdir/va/reg_out_va_all_fig.smcl", replace text name(reg_out_va_all_fig)
