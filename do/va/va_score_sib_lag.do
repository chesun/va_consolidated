...
OUTPUTS (CANONICAL per ADR-0021 sandbox)
    ...
    $logdir/va_score_sib_lag.smcl + .log
...
log using "$logdir/va_score_sib_lag.smcl", replace text
...
cap log close
cap translate "$logdir/va_score_sib_lag.smcl" ///
  "$logdir/va_score_sib_lag.log", replace
