...
OUTPUTS (CANONICAL per ADR-0021 sandbox)
    ...
    $logdir/reg_out_va_dk_all.smcl + .log
...
log using "$logdir/reg_out_va_dk_all.smcl", replace text
...
cap log close
cap translate "$logdir/reg_out_va_dk_all.smcl" ///
  "$logdir/reg_out_va_dk_all.log", replace
