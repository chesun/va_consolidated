...
| do/samples/touse_va.do | no-hardcoded-paths | 2026-05-07T20:30Z | 9160717e4b96 | PASS | grep -nE '"/Users\|"/home\|"C:\\\\' returned 0 matches |
| do/samples/touse_va.do | adr-0021-sandbox-write | 2026-05-07T20:30Z | 9160717e4b96 | PASS | sole persistent save at L324 targets CANONICAL `$datadir_clean/sbac/va_samples.dta`; log + translate target CANONICAL `$logdir/`; no LEGACY writes |
| do/samples/touse_va.do | legacy-include-macro-trace | 2026-05-07T20:30Z | 9160717e4b96 | PASS | LEGACY include `$matt_files_dir/merge_k12_postsecondary.doh` references no top-level `$<global>`s (Matt's args-based file); other includes are CONSOLIDATED (do/va/helpers/macros_va.doh, do/samples/create_diff_school_prop.doh) |
| do/samples/create_score_samples.do | no-hardcoded-paths | 2026-05-07T20:30Z | 8bfed6e6d1cf | PASS | grep -nE '"/Users\|"/home\|"C:\\\\' returned 0 matches |
| do/samples/create_score_samples.do | adr-0021-sandbox-write | 2026-05-07T20:30Z | 8bfed6e6d1cf | PASS | all 8 persistent saves target CANONICAL `$datadir_clean/va_samples_`version'/score_*.dta`; tempfile save at L203 exempt per established convention; log + translate target CANONICAL `$logdir/` |
| do/samples/create_score_samples.do | legacy-include-macro-trace | 2026-05-07T20:30Z | 8bfed6e6d1cf | ASSUMED | LEGACY merge helpers (`merge_loscore.doh`, `merge_sib.doh`, `merge_va_smp_acs.doh`, `merge_lag2_ela.doh`) live out-of-repo at `$vaprojdir/do_files/sbac/`; predecessor grep returned no top-level `$<global>` references but file contents not committed-in-repo so trace not fully auditable. `$distance_dtadir` referenced by `merge_k12_postsec_dist.doh` is bound in do/settings.do per this batch's prereq edit. Cost: out-of-repo audit |
| do/samples/create_out_samples.do | no-hardcoded-paths | 2026-05-07T20:30Z | e630c5306feb | PASS | grep -nE '"/Users\|"/home\|"C:\\\\' returned 0 matches |
| do/samples/create_out_samples.do | adr-0021-sandbox-write | 2026-05-07T20:30Z | e630c5306feb | PASS | all 8 persistent saves target CANONICAL `$datadir_clean/va_samples_`version'/out_*.dta`; tempfile save at L196 exempt; log + translate target CANONICAL `$logdir/` |
| do/samples/create_out_samples.do | legacy-include-macro-trace | 2026-05-07T20:30Z | e630c5306feb | ASSUMED | Same as create_score_samples.do — LEGACY merge helpers out-of-repo; `$matt_files_dir/merge_k12_postsecondary.doh` bound; trace not fully auditable. Cost: out-of-repo audit |
